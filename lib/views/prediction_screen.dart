      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Upload a dental disease image for prediction',
                style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
              ),
              const SizedBox(height: 10),
              const Text(
                'Use images color of your teeth. The images should be in JPEG, JPG or PNG format.',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                      image: AssetImage('assets/images/dental_logo.png'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
