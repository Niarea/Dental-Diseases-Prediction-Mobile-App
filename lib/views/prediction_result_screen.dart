                ...
                return Column(
                  ...
                  children: [
                    ...
                    _buildInformationDetail(1,
                        'A high confidence score indicates the model is certain about its prediction, but it\'s not a diagnosis. I remind you that this application aims to help you diagnose oral diseases early. You should therefore seek the advice of a dentist.'),
